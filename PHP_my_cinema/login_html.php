...
<h3>Find members</h3><br>
<form class="members" action=login_html.php method="post">
    <label for="nom">Name<input type="text" name="nom" id="nom"></label><br>
    <label for="prenom">Firstname<input type="text" name="prenom" id="prenom"></label><br>
